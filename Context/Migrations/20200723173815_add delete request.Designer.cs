...
namespace Context.Migrations
{
    ...
    [Migration("20200723173815_add delete request")]
    partial class adddeleterequest
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Models.DbModels.Request", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("Models.DbModels.Request", b =>
                {
                    b.HasOne("Models.DbModels.Book", "Book")
                        .WithMany()
                        .HasForeignKey("BookId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();

                    b.HasOne("Models.DbModels.User", "Receiver")
                        .WithMany("ReceivedRequests")
                        .HasForeignKey("ReceiverId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();

                    b.HasOne("Models.DbModels.User", "Sender")
