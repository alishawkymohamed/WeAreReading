...
export class SwaggerClient {
     ...
     * @return Success
     */
    api_Account_Logout(refreshToken: string | null | undefined): Observable<void> {
    ...
    protected processApi_Account_Logout(response: HttpResponseBase): Observable<void> {
        const status = response.status;
        const responseBlob = 
            response instanceof HttpResponse ? response.body : 
            (<any>response).error instanceof Blob ? (<any>response).error : undefined;
     ...
     * @param categoriesIds (optional) 
     * @return Success
     */
    api_Book_GetAllForUser(userId: number | null | undefined, count: number | null | undefined, search: string | null | undefined, categoriesIds: number[] | null | undefined): Observable<BookDTO[]> {
        ...
        if (categoriesIds !== undefined)
            categoriesIds && categoriesIds.forEach(item => { url_ += "categoriesIds=" + encodeURIComponent("" + item) + "&"; });
        url_ = url_.replace(/[?&]$/, "");
     ...
     * @return Success
     */
    api_Book_GetAllForOthers(search: string | null | undefined, categoriesIds: number[] | null | undefined): Observable<BookDTO[]> {
     ...
     * @return Success
     */
    api_Book_GetAll(search: string | null | undefined, categoriesIds: number[] | null | undefined): Observable<BookDTO[]> {
        ...
        return this.http.request("get", url_, options_).pipe(_observableMergeMap((response_ : any) => {
            return this.processApi_Book_GetAll(response_);
        })).pipe(_observableCatch((response_: any) => {
            if (response_ instanceof HttpResponseBase) {
                try {
                    return this.processApi_Book_GetAll(<any>response_);
                } catch (e) {
                    return <Observable<BookDTO[]>><any>_observableThrow(e);
                }
            } else
    ...
    protected processApi_Book_GetAll(response: HttpResponseBase): Observable<BookDTO[]> {
        const status = response.status;
        const responseBlob = 
            response instanceof HttpResponse ? response.body : 
            (<any>response).error instanceof Blob ? (<any>response).error : undefined;
     ...
     * @return Success
     */
    api_Book_GetDetails(bookId: number | undefined): Observable<BookDTO> {
        let url_ = this.baseUrl + "/api/Book/GetDetails?";
        if (bookId === null)
        ...
        return this.http.request("get", url_, options_).pipe(_observableMergeMap((response_ : any) => {
            return this.processApi_Book_GetDetails(response_);
        })).pipe(_observableCatch((response_: any) => {
            if (response_ instanceof HttpResponseBase) {
                try {
                    return this.processApi_Book_GetDetails(<any>response_);
                } catch (e) {
                    return <Observable<BookDTO>><any>_observableThrow(e);
                }
            } else
    ...
    protected processApi_Book_GetDetails(response: HttpResponseBase): Observable<BookDTO> {
        const status = response.status;
        const responseBlob = 
            response instanceof HttpResponse ? response.body : 
            (<any>response).error instanceof Blob ? (<any>response).error : undefined;
